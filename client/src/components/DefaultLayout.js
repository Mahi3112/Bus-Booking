  ...
  return (
    <div className="flex w-full">
          ...
          {menutoBeRendered.map((item, key) => {
            return (
              <div
                key={key}
                className={`${
                  activeRoute === item.path && "bg-gray-500 btn-disabled"
              ...
              >
                ...
                ></i>
                <i
                  className={`${item.icon} text-black text-[20px] group-hover:text-black`}
                ></i>
      ...
      <div className="w-full">
        <div className="bg-gray-400 flex flex-col justify-start items-center py-2">
          <img
            onClick={() => navigate("/")}
            className="w-30 h-20 rounded-full cursor-pointer"
          />
          <h1 className="text-black text-base mb-0 p-0 text-center ">
