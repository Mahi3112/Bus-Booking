        ...
        <div className="h-screen flex bg-black">
          ...
          <div className="flex w-full lg:w-1/2 justify-center items-center space-y-8">
            <div className="w-3/4 px-8 md:px-32 lg:px-24">
              ...
              <h1 className="mb-8 text-5xl text-center font-bold italic text-white">
                Register
              </h1>
              <Form.Item
                name="name"
              ...
              >
                <div className="relative z-0 mb-6 w-full group">
                  <input
                    ...
                    className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-white-500 dark:focus:border-white-700 focus:outline-none focus:ring-0 focus:border-white peer"
                    placeholder=" "
                    required
                  />
                  <label
              ...
              >
                <div className="relative z-0 mb-6 w-full group">
                  <input
                    type="email"
                    name="floating_email"
                    className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-white dark:border-white-500 dark:focus:border-white-700 focus:outline-none focus:ring-0 focus:border-white peer"
                    placeholder=" "
                    required
                  />
                  <label
