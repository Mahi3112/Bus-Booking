...
<div className="hero-content text-center text-neutral-content" style={{ paddingLeft: "9rem", paddingRight: "9rem" }}>
          <div className="max-w-md ">
            ...
            <p className="mb-5 text-xl text-white">
              allows you to book your bus tickets online 
            </p>
            <Link
              to="/login"
            ...
            >
              ...
              <span className="absolute top-0 left-0 w-48 h-48 -mt-1 transition-all duration-500 ease-in-out rotate-45 -translate-x-56 -translate-y-24 bg-white opacity-100 group-hover:translate-x-1"></span>
            ...
            <div className="w-full my-5 mx-2 p-2 px-2 py-3 flex justify-center">
              <Row gutter={10} align="center">
                <Col lg={12} sm={24}>
                  <select
                    className="mb-5 select w-full max-w-xs"
                    onChange={(e) => {
                ...
                <Col lg={24} sm={24}>
                  <input
                    className="mb-5 input input-bordered w-full max-w-xs"
                ...
                <Col lg={24} sm={24}>
                  <div className="flex justify-center gap-4">
                    ...
                    >
                      ...
                      <span className="gap-5 absolute inset-0 border-2 border-white rounded-full"></span>
                    </button>
                  </div>
                </Col>
